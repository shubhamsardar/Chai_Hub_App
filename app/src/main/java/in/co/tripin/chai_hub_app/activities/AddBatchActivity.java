...
public class AddBatchActivity extends AppCompatActivity {
    ...
    public void addBatchThroughApi()
    {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        BatchRequestBody batchRequestBody = new BatchRequestBody(editTextBatchName.getText().toString(),editTextBatchNo.getText().toString(),)

        BatchService batchService = retrofit.create(BatchService.class);
        Call<BatchRequestBody> call = batchService.toAddBatch(preferenceManager.getAccessToken(),)
    }
}
